...
observed variables [@mardiaMultivariateAnalysis1979]. 


It provides a useful tool for exploring the covariance structure among observable variables [@hiroseSparseEstimationNonconcave2015]. One of the major assumptions that factor analytic model stands on
