...
where $\boldsymbol{y}_i|\boldsymbol{f}_i \sim N(\boldsymbol{\Lambda}\boldsymbol{f}_i, \boldsymbol{\Psi})$ and $\boldsymbol{f}_i \sim N(\boldsymbol{0}_k,\boldsymbol{I}_k)$.
:::
\begin{align*}
...
$$ 
where $\mathbb{V}[\boldsymbol{f}_i|_{(k)}]$ is the variance of conditional distribution. 
